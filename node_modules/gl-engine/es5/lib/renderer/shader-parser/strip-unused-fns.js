...
exports.default = stripUnusedFunctions;

var _string = require('glsl-tokenizer/string');

var _string2 = _interopRequireDefault(_string);

var _glslTokenString = require('glsl-token-string');
...
function stripUnusedFunctions(src) {
  var tokens = (0, _string2.default)(src);
  ...
  return (0, _glslTokenString2.default)(tokens);
}
